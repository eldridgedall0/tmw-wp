 ...
 * Change from original: the hardcoded "Remember me" checkbox in
 * .tmw-auth-extras has been replaced with do_action('tmw_login_extras').
 * When TMW Core is active it renders "Stay logged in on this device".
 * When TMW Core is inactive the fallback below shows plain "Remember me"
 * so the login page never breaks regardless of plugin state.
 */
        ...
        <div class="tmw-auth-card">
            ...
            <form id="tmw-login-form" class="tmw-auth-form" method="post">
                ...
                <div class="tmw-auth-extras">
                     ...
                     * tmw_login_extras
                     *
                     * Plugins hook here to inject fields between the password
                     * input and the forgot-password link.
                     *
                     * TMW Core hooks in to render "Stay logged in on this device".
                     * Fallback shows plain "Remember me" when TMW Core is inactive.
                     */
                    if ( has_action( 'tmw_login_extras' ) ) {
                        do_action( 'tmw_login_extras' );
                    } else {
                        ?>
